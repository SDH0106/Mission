...
public class MonthlyMission : IMission
{
    ...
    public MonthlyMission(ulong id, string iconId, int lifeCycleType, string nameId, string explainId, double completionCount, int rewardType, ulong rewardAmount, List<string> missionExplainElement, MissionObjective[] missionObjectives)
    {
        this.Id = id;
        this.IconId = iconId;
        this.NameId = nameId;
