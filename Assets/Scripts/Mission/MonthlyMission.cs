...
public class MonthlyMission : IMission
{
    ...
    public MonthlyMission(ulong id, string iconId, int lifeCycleType, string nameId, string explainId, int type, double completionCount, int rewardType, ulong rewardAmount, List<string> missionExplainElements = null, Dictionary<RandomMission.MissionElementTypes, string> randomMissionElements = null)
    {
        this.Id = id;
        this.IconId = iconId;
        this.nameId = nameId;
    ...
    public bool CheckComplete()
    {
        ...
        if (CompletionCount <= Count)
        {
            ...
            IMission mission = GameData.Instance.GetMission(GameData.Instance.BasicMissions[2]);
            mission.AddCount(1);
